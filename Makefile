...
.PHONY: run
run:
	substreams run -e eos.firehose.eosnation.io:9001 prom_out -s 298031857 -t +1 -o jsonl

.PHONY: gui
gui:
	substreams gui -e eos.firehose.eosnation.io:9001 prom_out -s 298031857 -t +1
